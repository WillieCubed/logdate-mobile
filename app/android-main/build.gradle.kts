...
dependencies {
    ...
    screenshotTestImplementation(projects.client.feature.events)
    screenshotTestImplementation(projects.client.feature.postcards)
    screenshotTestImplementation(projects.client.calendarSync)
