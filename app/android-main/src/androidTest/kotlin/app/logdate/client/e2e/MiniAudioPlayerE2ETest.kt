...
class MiniAudioPlayerE2ETest {
    ...
    private fun assertOutputRouteControlsAreUsable() {
        composeRule.onNodeWithText("Voice note from journal").assertIsDisplayed()
    ...
    private fun setMiniPlayerContent() {
    ...
    private fun playbackState(): AudioPlaybackState =
        AudioPlaybackState(
            ...
            currentUri = "content://logdate/audio/mini-player.m4a",
            isPlaying = true,
            progress = 0.42f,
            duration = 2.minutes,
            displayInfo =
                AudioPlaybackDisplayInfo(
                    title = "Voice note from journal",
                    subtitle = "1:48",
                ),
