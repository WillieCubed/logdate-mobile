package app.logdate.screenshots.rewind
...
@Preview(showBackground = true, device = PHONE)
@Composable
fun RewindOverview_NotReady_Generating() {
    ScreenshotTheme {
        RewindScreenContent(
...
@Preview(showBackground = true, device = PHONE)
@Composable
fun RewindPanel_NarrativeContext() {
    ScreenshotTheme {
        RewindStoryContent(
