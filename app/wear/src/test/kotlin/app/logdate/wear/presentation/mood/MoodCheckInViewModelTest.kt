...
class MoodCheckInViewModelTest {
    ...
    @Test
    fun `initial state is SELECT_MOOD with no selection`() = runTest {
    ...
    @Test
    fun `selectMood transitions to VOICE_PROMPT`() = runTest {
        viewModel.uiState.test {
    ...
    @Test
    fun `skipVoiceAttachment saves note with mood tag`() = runTest {
    ...
    @Test
    fun `skipVoiceAttachment transitions to SAVED`() = runTest {
    ...
    @Test
    fun `skipVoiceAttachment emits NavigateBack event`() = runTest {
    ...
    @Test
    fun `attachVoice emits NavigateToVoiceNote event`() = runTest {
    ...
    @Test
    fun `skipVoiceAttachment does nothing without mood selection`() = runTest {
        viewModel.skipVoiceAttachment()
