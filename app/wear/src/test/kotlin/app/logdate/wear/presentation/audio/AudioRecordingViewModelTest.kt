...
class AudioRecordingViewModelTest {
    ...
    @Test
    fun `startRecording transitions to recording state`() = runTest {
        val viewModel = createViewModel()
    ...
    @Test
    fun `startRecording checks storage before starting`() = runTest {
        val viewModel = createViewModel()
    ...
    @Test
    fun `startRecording starts audio level collection`() = runTest {
        val viewModel = createViewModel()
    ...
    @Test
    fun `startRecording shows error when storage insufficient`() = runTest {
    ...
    @Test
    fun `startRecording shows error when manager returns false`() = runTest {
    ...
    @Test
    fun `startRecording shows error when manager throws`() = runTest {
    ...
    @Test
    fun `stopRecording saves note and navigates back`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `stopRecording creates Audio note with correct file path`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `stopRecording shows error when file path is null`() = runTest {
    ...
    @Test
    fun `stopRecording shows error when exception thrown`() = runTest {
    ...
    @Test
    fun `pauseRecording updates isPaused to true`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `pauseRecording calls manager`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `pauseRecording does not update state when manager returns false`() = runTest {
    ...
    @Test
    fun `resumeRecording updates isPaused to false`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
        viewModel.pauseRecording()
    ...
    @Test
    fun `resumeRecording calls manager`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `cancelRecording releases manager and navigates back`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `cancelRecording does not save note`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `audio levels are bounded to 50 entries`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `duration increases while recording`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `isLoading is false in initial state`() = runTest {
        val viewModel = createViewModel()
        assertFalse(viewModel.uiState.value.isLoading)
    }

    @Test
    fun `isLoading is false after recording starts`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
    ...
    @Test
    fun `isLoading is false after recording stops`() = runTest {
        val viewModel = createViewModel()
        viewModel.startRecording()
        advanceTimeBy(200)
        viewModel.stopRecording()
