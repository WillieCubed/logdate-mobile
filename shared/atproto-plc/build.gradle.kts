...
kotlin {
    ...
    android {
        namespace = "studio.hypertext.atproto.plc"
        compileSdk =
...
publishing {
    publications.withType(MavenPublication::class.java).configureEach {
        pom {
            name.set("atproto-plc")
            description.set("Kotlin Multiplatform PLC directory primitives and client helpers for AT Protocol.")
