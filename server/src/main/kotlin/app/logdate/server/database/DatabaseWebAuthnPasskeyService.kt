...
class DatabaseWebAuthnPasskeyService(
    ...
    suspend fun verifyAuthentication(
        ...
        return try {
            ...
            val userId =
                findUserByCredentialId(authenticationResponse.id)
     ...
     */
    suspend fun getPasskeysForUser(userId: Uuid): List<PasskeyInfo> = passkeyRepository.findActiveByAccountId(userId)
