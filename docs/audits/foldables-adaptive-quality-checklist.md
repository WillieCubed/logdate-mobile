...
| `[todo]` | Empty journals state | First-journal creation affordances still need compact, expanded, and book-posture evidence. | `NoJournalsScreen` |
...
| `[partial]` | Empty journals state | `NoJournalsScreen` exists inside the journal list panel, but the first-journal empty state has no compact, expanded, or book-posture evidence yet. | Add runtime screenshots for empty-state creation affordances in compact, expanded, and book posture. |
