 ...
 *
 * Implements [ExternalPlacesProvider]. The required API key is resolved in priority order:
 * the explicit [apiKey] constructor parameter, the `com.google.android.geo.API_KEY` manifest
 * metadata, or the `google_api_key` string resource generated by the google-services plugin.
 * If no key is found, searches silently return empty results.
 */
