...
class IosBatteryInfoProvider : BatteryInfoProvider {
    ...
    private val batteryStateFlow = MutableStateFlow(getCurrentBatteryStateInternal())
    ...
    init {
        ...
        val stateObserver =
            notificationCenter.addObserverForName(
                ...
                { _ -> batteryStateFlow.value = getCurrentBatteryStateInternal() },
            )
    ...
    override suspend fun getCurrentBatteryState(): BatteryState = getCurrentBatteryStateInternal()

    override suspend fun isPowerSaveMode(): Boolean = processInfo.lowPowerModeEnabled
