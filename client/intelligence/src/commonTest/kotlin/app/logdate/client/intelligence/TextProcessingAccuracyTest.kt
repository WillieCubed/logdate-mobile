...
class TextProcessingAccuracyTest {
    ...
    fun workMeetingEntry_handlesBusinessContext() =
        runTest(testDispatcher) {
            ...
            val expectedSummary =
                "You attended an important quarterly meeting with leadership and had a productive follow-up with your manager."
    ...
    fun familyGatheringEntry_handlesFamilyRelationships() =
        runTest(testDispatcher) {
            ...
            val expectedSummary =
                "You enjoyed a heartwarming family gathering filled with good food, stories, and quality time with multiple generations."
    ...
    fun medicalAppointmentEntry_handlesHealthcareContext() =
        runTest(testDispatcher) {
            ...
            val expectedSummary =
                "You completed your annual medical checkup with positive results and scheduled appropriate follow-up care."
    ...
    fun emotionalEntry_maintainsContextInSummary() =
        runTest(testDispatcher) {
            ...
            val expectedSummary =
                "You navigated a challenging day at work but found comfort and perspective through conversations with supportive people in your life."
    ...
    fun achievementEntry_capturesPositiveContext() =
        runTest(testDispatcher) {
            ...
            val expectedSummary =
                "You achieved a major career milestone with your promotion and celebrated this significant accomplishment with supportive colleagues and family."
