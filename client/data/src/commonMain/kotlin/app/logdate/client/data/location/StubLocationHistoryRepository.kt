...
class StubLocationHistoryRepository : LocationHistoryRepository {
    private val mockLocationHistory =
        listOf(
            LocationHistoryItem(
                userId = "mock_user",
    ...
    override suspend fun getAllLocationHistory(): List<LocationHistoryItem> = mockLocationHistory.sortedByDescending { it.timestamp }

    override fun observeLocationHistory(): Flow<List<LocationHistoryItem>> = flowOf(mockLocationHistory.sortedByDescending { it.timestamp })
    ...
    override suspend fun getLastLocation(): LocationHistoryItem? = mockLocationHistory.maxByOrNull { it.timestamp }

    override fun observeLastLocation(): Flow<LocationHistoryItem?> = flowOf(mockLocationHistory.maxByOrNull { it.timestamp })
    ...
    override suspend fun getLocationCount(): Int = mockLocationHistory.size
}
