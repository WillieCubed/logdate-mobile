...
interface IndexedMediaDao {
     ...
     */
    @Transaction
    suspend fun isMediaIndexed(uri: String): Boolean = isImageIndexed(uri) || isVideoIndexed(uri)
     ...
     */
    @Transaction
    suspend fun getAllMediaForPeriod(
        start: Instant,
        end: Instant,
    ): IndexedMediaContent {
