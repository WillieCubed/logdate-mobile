...
class IdentityKeyManager(
     ...
     */
    suspend fun hasIdentityKey(): Boolean {
        return secureStorage.getBytes(KEY_IDENTITY_KEY) != null
    }
...
class IdentityKeyNotFoundException(message: String) : Exception(message)
