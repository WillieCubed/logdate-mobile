...
class AesGcmMediaPayloadCryptoTest {
    @Test
    fun encryptAddsPrefixAndDecrypts() = runTest {
    ...
    @Test
    fun encryptSkipsAlreadyPrefixedPayloads() = runTest {
    ...
    @Test
    fun decryptPassesThroughPlaintext() = runTest {
    ...
    @Test
    fun decryptFailsOnTamperedCiphertext() = runTest {
