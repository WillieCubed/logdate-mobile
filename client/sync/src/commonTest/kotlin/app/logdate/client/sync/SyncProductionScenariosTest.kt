...
class SyncProductionScenariosTest {
    ...
    @Test
    fun testLargeScaleSyncWith100Items() = runTest {
    ...
    @Test
    fun testPartialBatchFailureRollback() = runTest {
        val apiClient = FakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
    ...
    @Test
    fun testNetworkTimeoutDuringUpload() = runTest {
        val apiClient = FakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
    ...
    @Test
    fun testMultipleFailureTypesInSingleSync() = runTest {
        val apiClient = FakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
    ...
    @Test
    fun testSyncWithMixedSuccessAndFailure() = runTest {
        val apiClient = fakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
    ...
    @Test
    fun testRepeatedFailuresTrackCumulativeErrors() = runTest {
        val apiClient = FakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
    ...
    @Test
    fun testSyncRecoveryAfterMultipleFailures() = runTest {
        val apiClient = fakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
    ...
    @Test
    fun testAuthenticationRequiredMidwayThroughSync() = runTest {
        val apiClient = FakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
    ...
    @Test
    fun testPartialDownloadWithMixedResults() = runTest {
        val apiClient = fakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
    ...
    @Test
    fun testUploadPendingChangesWithEmptyQueue() = runTest {
        val apiClient = fakeCloudApiClient()
        val syncMetadataService = fakeSyncMetadataService()
