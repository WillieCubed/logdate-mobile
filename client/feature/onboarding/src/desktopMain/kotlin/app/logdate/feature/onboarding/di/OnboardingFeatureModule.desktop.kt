...
import app.logdate.feature.onboarding.flow.FileOnboardingDeviceStateRepository
...
actual val onboardingFeatureModule: Module =
    module {
        ...
        single<OnboardingDeviceStateRepository> { FileOnboardingDeviceStateRepository() }
