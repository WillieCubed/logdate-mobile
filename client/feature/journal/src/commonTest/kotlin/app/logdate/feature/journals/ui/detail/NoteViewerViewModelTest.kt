...
class NoteViewerViewModelTest {
    ...
    @Test
    fun mapsTextNoteToContentState() = runTest(dispatcher) {
        ...
        val viewModel = NoteViewerViewModel(
            noteId = noteId,
    ...
    @Test
    fun mapsImageNoteToContentState() = runTest(dispatcher) {
        val noteId = Uuid.random()
        val now = Instant.parse("2025-01-01T00:00:00Z")
    ...
    @Test
    fun mapsVideoNoteToContentState() = runTest(dispatcher) {
        val noteId = Uuid.random()
        val now = Instant.parse("2025-01-01T00:00:00Z")
    ...
    @Test
    fun mapsAudioNoteToContentState() = runTest(dispatcher) {
        val noteId = Uuid.random()
        val now = Instant.parse("2025-01-01T00:00:00Z")
    ...
    @Test
    fun deleteNoteInvokesUseCase() = runTest(dispatcher) {
        val noteId = Uuid.random()
        val now = Instant.parse("2025-01-01T00:00:00Z")
        val note = JournalNote.Text(
            uid = noteId,
