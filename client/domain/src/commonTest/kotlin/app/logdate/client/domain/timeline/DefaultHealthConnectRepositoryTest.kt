...
class DefaultHealthConnectRepositoryTest {
    ...
    @Test
    fun `getDayBoundsForDate returns default bounds`() =
        runTest {
            // Given
    ...
    @Test
    fun `getDayBoundsForDate handles different time zones correctly`() =
        runTest {
            // Given
    ...
    @Test
    fun `getDayBoundsForDate handles date at start of year`() =
        runTest {
            // Given
    ...
    @Test
    fun `getDayBoundsForDate handles date at end of year`() =
        runTest {
            // Given
    ...
    @Test
    fun `getDayBoundsForDate handles leap year date`() =
        runTest {
            // Given
    ...
    @Test
    fun `isHealthConnectAvailable returns false`() =
        runTest {
            // When
    ...
    @Test
    fun `hasSleepPermissions returns false`() =
        runTest {
            // When
    ...
    @Test
    fun `requestSleepPermissions returns false`() =
        runTest {
            // When
    ...
    @Test
    fun `day bounds span exactly one day`() =
        runTest {
            // When
            val result = repository.getDayBoundsForDate(testDate, testTimeZone)
