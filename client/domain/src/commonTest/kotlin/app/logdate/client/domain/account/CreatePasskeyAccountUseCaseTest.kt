...
class CreatePasskeyAccountUseCaseTest {
    ...
    @Test
    fun `invoke with valid data should create account successfully`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
                    ...
                    override suspend fun checkUsernameAvailability(username: String): kotlin.Result<Boolean> = kotlin.Result.success(true)
    ...
    @Test
    fun `invoke with taken username should return username taken error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
                    ...
                    override suspend fun checkUsernameAvailability(username: String): kotlin.Result<Boolean> = kotlin.Result.success(false)
    ...
    @Test
    fun `invoke with invalid username should return username invalid error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with username containing invalid characters should return username invalid error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with invalid display name should return display name invalid error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with network error during availability check should return network error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with passkey cancelled error should map correctly`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with valid data and null bio should create account successfully`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
