...
class ExtractPeopleUseCaseTest {
            ...
            val useCase =
                object {
                    suspend operator fun invoke(
                        documentId: String,
                        text: String,
                    ): AIResult<List<Person>> = mockExtractor.extractPeople(documentId, text)
                }
    ...
    @Test
    fun `invoke should return empty list when no people found`() =
        runTest {
            // Given
            ...
            val mockExtractor =
                object {
                    suspend fun extractPeople(
                        documentId: String,
                        text: String,
                    ): AIResult<List<Person>> = AIResult.Success(emptyList())
                }
    ...
    @Test
    fun `invoke should handle single person extraction`() =
        runTest {
            // Given
            ...
            val mockExtractor =
                object {
                    suspend fun extractPeople(
                        documentId: String,
                        text: String,
                    ): AIResult<List<Person>> = AIResult.Success(listOf(expectedPerson))
                }
    ...
    @Test
    fun `invoke should handle empty text`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should handle whitespace-only text`() =
        runTest {
            // Given
