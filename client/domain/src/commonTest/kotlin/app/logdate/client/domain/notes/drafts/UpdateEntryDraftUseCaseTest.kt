...
class UpdateEntryDraftUseCaseTest {
    ...
    @Test
    fun `invoke with notes list should update draft and return draft ID`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke with EntryDraft should update draft and return draft ID`() =
        runTest {
            // Given
            val draftId = Uuid.random()
    ...
    @Test
    fun `invoke with overwrite true should update draft normally`() =
        runTest {
            // Given
            val draftId = Uuid.random()
    ...
    @Test
    fun `invoke with overwrite false should still update draft`() =
        runTest {
            // Given
            val draftId = Uuid.random()
    ...
    @Test
    fun `invoke should handle multiple update operations`() =
        runTest {
            // Given
