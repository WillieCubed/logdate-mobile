...
class FetchMostRecentDraftUseCaseTest {
    ...
    @Test
    fun `invoke should return most recent draft by updatedAt timestamp`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return null when no drafts exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should handle multiple drafts with same timestamp`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should correctly sort drafts with different timestamps`() =
        runTest {
            // Given
            val now = Clock.System.now()
