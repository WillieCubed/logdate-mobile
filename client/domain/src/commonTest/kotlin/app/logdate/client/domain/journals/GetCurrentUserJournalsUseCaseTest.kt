...
class GetCurrentUserJournalsUseCaseTest {
    ...
    @Test
    fun `invoke should return flow of all journals from repository`() =
        runTest {
            // Given
            val mockRepository = MockJournalRepository()
            val expectedJournals =
                listOf(
                    Journal(
                        id = Uuid.random(),
    ...
    @Test
    fun `invoke should return empty flow when no journals exist`() =
        runTest {
            // Given
            val mockRepository = MockJournalRepository()
    ...
    @Test
    fun `invoke should return single journal when only one exists`() =
        runTest {
            // Given
            val mockRepository = MockJournalRepository()
            val singleJournal =
    ...
    @Test
    fun `invoke should handle multiple emissions from repository`() =
        runTest {
            // Given
            val mockRepository = MockJournalRepository()
            val firstEmission =
    ...
    @Test
    fun `invoke should preserve order of journals from repository`() =
        runTest {
            // Given
            val mockRepository = MockJournalRepository()
            val orderedJournals =
    ...
    @Test
    fun `invoke should handle reactive updates to journal list`() =
        runTest {
            // Given
            val mockRepository = MockJournalRepository()
            val initialJournals =
