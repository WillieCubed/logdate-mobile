...
class GetMediaUrisUseCaseTest {
    ...
    @Test
    fun `invoke should return media URIs for given day`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return empty list when no media exists for day`() =
        runTest {
            // Given
            val testDay = LocalDate(2024, 1, 15)
    ...
    @Test
    fun `invoke should query media for correct time range`() =
        runTest {
            // Given
            val testDay = LocalDate(2024, 1, 15)
            mockMediaManager.mediaObjects = emptyList()
    ...
    @Test
    fun `invoke should handle single media object`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should handle different media types correctly`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should handle large number of media objects`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should work with different dates`() =
        runTest {
            // Given
    ...
    private fun createImageMediaObject(uri: String) =
        MediaObject.Image(
            uri = uri,
            size = 1024,
            name = uri,
    ...
    private fun createVideoMediaObject(uri: String) =
        MediaObject.Video(
            name = uri,
            uri = uri,
            size = 2048,
