...
class CheckUsernameAvailabilityUseCaseTest {
    ...
    @Test
    fun `invoke with taken username should return success false`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with blank username should return invalid username error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with too short username should return invalid username error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with too long username should return invalid username error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with invalid characters should return invalid username error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with network error should return network error`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
