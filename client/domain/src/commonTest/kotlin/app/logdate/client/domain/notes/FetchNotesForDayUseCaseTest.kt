...
class FetchNotesForDayUseCaseTest {
    ...
    @Test
    fun `invoke should return notes for specified day`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return empty list when no notes exist for day`() =
        runTest {
            // Given
            val testDate = LocalDate(2024, 1, 15)
    ...
    @Test
    fun `invoke should call repository with correct time range for given date`() =
        runTest {
            // Given
            val testDate = LocalDate(2024, 1, 15)
            mockRepository.notesForRange = emptyList()
    ...
    @Test
    fun `invoke should return single note correctly`() =
        runTest {
            // Given
