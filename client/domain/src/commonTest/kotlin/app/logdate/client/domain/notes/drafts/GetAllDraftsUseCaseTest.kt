...
class GetAllDraftsUseCaseTest {
    ...
    @Test
    fun `invoke should return all drafts from repository`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return empty list when no drafts exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return single draft when only one exists`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should handle large number of drafts`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should preserve draft order from repository`() =
        runTest {
            // Given
    ...
    private fun createTestDraft(content: String = "Test draft content") =
        EntryDraft(
            id = Uuid.random(),
            notes =
                listOf(
