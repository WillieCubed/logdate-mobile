...
class SignOutUseCaseTest {
        ...
        runTest {
            ...
            val mockRepository =
                object : PasskeyAccountRepository {
                    ...
                    override suspend fun signOut(): kotlin.Result<Unit> = kotlin.Result.success(Unit)
    ...
    @Test
    fun `invoke should return error when repository signout fails`() =
        runTest {
            // Given
            ...
            val mockRepository =
                object : PasskeyAccountRepository {
                    ...
                    override suspend fun signOut(): kotlin.Result<Unit> = kotlin.Result.failure(Exception(errorMessage))
        ...
        runTest {
            ...
            val mockRepository =
                object : PasskeyAccountRepository {
                    ...
                    override suspend fun signOut(): kotlin.Result<Unit> = throw RuntimeException(errorMessage)
    ...
    @Test
    fun `invoke should handle null exception message gracefully`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
                    ...
                    override suspend fun signOut(): kotlin.Result<Unit> = kotlin.Result.failure(Exception(null as String?))
