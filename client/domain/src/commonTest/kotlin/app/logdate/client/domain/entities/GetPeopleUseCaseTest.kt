...
class GetPeopleUseCaseTest {
    ...
    @Test
    fun `invoke should return flow of all people from repository`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return empty flow when no people exist`() =
        runTest {
            // Given
            val mockRepository = MockPeopleRepository()
    ...
    @Test
    fun `invoke should return single person when only one exists`() =
        runTest {
            // Given
            val mockRepository = MockPeopleRepository()
    ...
    @Test
    fun `invoke should preserve order of people from repository`() =
        runTest {
            // Given
            val mockRepository = MockPeopleRepository()
            val orderedPeople =
