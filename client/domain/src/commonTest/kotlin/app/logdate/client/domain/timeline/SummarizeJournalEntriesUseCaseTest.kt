...
class SummarizeJournalEntriesUseCaseTest {
    ...
    @Test
    fun `invoke should return SummaryUnavailable when entries are empty`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return NetworkUnavailable when network is not available`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return Success when summarization succeeds`() =
        runTest {
            // Given
            val testEntries =
                listOf(
    ...
    @Test
    fun `invoke should return SummaryUnavailable when summarizer returns null`() =
        runTest {
            // Given
            val testEntries = listOf(createTestNote("Test content"))
            mockNetworkMonitor.isAvailable = true
    ...
    @Test
    fun `invoke should return SummaryUnavailable when summarizer throws exception`() =
        runTest {
            // Given
            val testEntries = listOf(createTestNote("Test content"))
            mockNetworkMonitor.isAvailable = true
    ...
    @Test
    fun `invoke should filter and sort text notes chronologically`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should generate consistent cache request for same entries`() =
        runTest {
            // Given
            val testEntries =
                listOf(
    ...
    @Test
    fun `invoke should handle single text note`() =
        runTest {
            // Given
