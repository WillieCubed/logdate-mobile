...
class GetCurrentAccountUseCaseTest {
    ...
    @Test
    fun `invoke with GetCurrentAccount request should return current account flow`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke with GetAuthenticationStatus request should return authentication status flow`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke with GetAccountState request should return authenticated state when account exists`() =
        runTest {
            // Given
            val accountFlow = MutableStateFlow(mockAccount)
            val mockRepository =
    ...
    @Test
    fun `invoke with GetAccountState request should return not authenticated state when account is null`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke with RefreshAccountInfo request should return success result`() =
        runTest {
            // Given
            val mockRepository =
                object : PasskeyAccountRepository {
    ...
    @Test
    fun `invoke with RefreshAccountInfo request should return failure result when repository fails`() =
        runTest {
            // Given
