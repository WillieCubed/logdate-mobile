...
class CreateEntryDraftUseCaseTest {
    ...
    @Test
    fun `invoke with list of notes should create draft and return draft ID`() =
        runTest {
            // Given
            val testNotes =
                listOf(
    ...
    @Test
    fun `invoke with single note should create draft and return draft ID`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke with empty list should create empty draft`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should handle multiple draft creations`() =
        runTest {
            // Given
