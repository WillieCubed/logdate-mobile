...
class JournalNoteAdapter(
    ...
    companion object {
         ...
         */
        fun fromNotes(notes: List<JournalNote>): List<JournalNoteAdapter> = notes.map { JournalNoteAdapter(it) }

        /**
         * Extracts the original JournalNotes from a list of JournalNoteAdapters.
         */
        fun toNotes(adapters: List<JournalNoteAdapter>): List<JournalNote> = adapters.map { it.getNote() }
    }
}
