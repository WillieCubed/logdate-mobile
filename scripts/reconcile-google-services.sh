...
#
# It is migration scaffolding. Once every google-services source carries the client,
# this becomes a no-op and both it and the mapping file should be deleted.
set -euo pipefail
